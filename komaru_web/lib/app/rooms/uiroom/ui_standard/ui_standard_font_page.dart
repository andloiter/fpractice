...
class UiStandardFontPage extends ConsumerStatefulWidget {
  const UiStandardFontPage({super.key});

  @override
  UiStandardFontPageState createState() => UiStandardFontPageState();
}

class UiStandardFontPageState extends ConsumerState<UiStandardFontPage> {
  // -------------------------------------------------------------------------------------------
  // 初期処理 画面構築時だけ
  // -------------------------------------------------------------------------------------------
  ...
  // ウジェット処理
  // ------------------------------------------------------------------------------------------------
  late final UiStandardFontPageWidget _pageWidget = UiStandardFontPageWidget();
  @override
        ...
        child: Scaffold(
          ...
          appBar: PreferredSize(
            ...
            child: AppBarAreaWidget(
                titleName: PUIRoomEnum.uiStandardFont.title, popIcon: false),
          ),
          body: SafeArea(
              top: true,
              child: DefaultTextStyle.merge(
                ...
                child: Column(
                  ...
                  children: [
                    Expanded(
                        child: WaitWidget(
                            titleName: PUIRoomEnum.uiStandardFont.title,
...
class UiStandardFontPageWidget extends ConsumerWidget {
  UiStandardFontPageWidget({super.key});
