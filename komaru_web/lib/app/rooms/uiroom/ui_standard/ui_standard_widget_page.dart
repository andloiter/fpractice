...
class UiStandardWidgetPage extends ConsumerStatefulWidget {
  const UiStandardWidgetPage({super.key});

  @override
  UiStandardWidgetPageState createState() => UiStandardWidgetPageState();
}

class UiStandardWidgetPageState extends ConsumerState<UiStandardWidgetPage> {
  // -------------------------------------------------------------------------------------------
  // 初期処理 画面構築時だけ
  // -------------------------------------------------------------------------------------------
  ...
  // ウジェット処理
  // ------------------------------------------------------------------------------------------------
  late final UiStandardWidgetPageWidget _pageWidget =
      UiStandardWidgetPageWidget();
  @override
        ...
        child: Scaffold(
          ...
          appBar: PreferredSize(
            ...
            child: AppBarAreaWidget(
                titleName: PUIRoomEnum.uiStandardWidget.title, popIcon: false),
          ),
          body: SafeArea(
              top: true,
              child: DefaultTextStyle.merge(
                ...
                child: Column(
                  ...
                  children: [
                    Expanded(
                        child: WaitWidget(
                            titleName: PUIRoomEnum.uiStandardWidget.title,
...
class UiStandardWidgetPageWidget extends ConsumerWidget {
  UiStandardWidgetPageWidget({super.key});
