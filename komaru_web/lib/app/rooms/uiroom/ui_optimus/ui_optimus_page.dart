...
class UiOptimusPage extends ConsumerStatefulWidget {
  const UiOptimusPage({super.key});

  @override
  UiOptimusPageState createState() => UiOptimusPageState();
}

class UiOptimusPageState extends ConsumerState<UiOptimusPage> {
  // -------------------------------------------------------------------------------------------
  // 初期処理 画面構築時だけ
  // -------------------------------------------------------------------------------------------
  ...
  // ウジェット処理
  // ------------------------------------------------------------------------------------------------
  late final UiOptimusPageWidget _pageWidget = UiOptimusPageWidget();
  @override
        ...
        child: Scaffold(
          ...
          appBar: PreferredSize(
            ...
            child: AppBarAreaWidget(
                titleName: PUIRoomEnum.uiOptimus.title, popIcon: false),
          ),
          body: SafeArea(
              top: true,
              child: DefaultTextStyle.merge(
                ...
                child: Column(
                  ...
                  children: [
                    Expanded(
                        child: WaitWidget(
                            titleName: PUIRoomEnum.uiOptimus.title,
...
class UiOptimusPageWidget extends ConsumerWidget {
  UiOptimusPageWidget({super.key});

  // -------------------------------------------------------------------------------------------
  // 部品
  // -------------------------------------------------------------------------------------------
  late final AppBarAreaWidget areaAppBar =
      AppBarAreaWidget(titleName: PUIRoomEnum.uiOptimus.title, popIcon: false);
