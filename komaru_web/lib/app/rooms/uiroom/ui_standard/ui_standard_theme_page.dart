...
class UiStandardThemePage extends ConsumerStatefulWidget {
  const UiStandardThemePage({super.key});

  @override
  UiStandardThemePageState createState() => UiStandardThemePageState();
}

class UiStandardThemePageState extends ConsumerState<UiStandardThemePage> {
  // -------------------------------------------------------------------------------------------
  // 初期処理 画面構築時だけ
  // -------------------------------------------------------------------------------------------
  ...
  // ウジェット処理
  // ------------------------------------------------------------------------------------------------
  late final UiStandardThemePageWidget _pageWidget =
      UiStandardThemePageWidget();
  @override
        ...
        child: Scaffold(
          ...
          appBar: PreferredSize(
            ...
            child: AppBarAreaWidget(
                titleName: PUIRoomEnum.uiStandardTheme.title, popIcon: false),
          ),
          body: SafeArea(
              top: true,
              child: DefaultTextStyle.merge(
                ...
                child: Column(
                  ...
                  children: [
                    Expanded(
                        child: WaitWidget(
                            titleName: PUIRoomEnum.uiStandardTheme.title,
...
class UiStandardThemePageWidget extends ConsumerWidget {
  UiStandardThemePageWidget({super.key});
