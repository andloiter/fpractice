...
class UiPlutoGridPage extends ConsumerStatefulWidget {
  const UiPlutoGridPage({super.key});

  @override
  UiPlutoGridPageState createState() => UiPlutoGridPageState();
}

class UiPlutoGridPageState extends ConsumerState<UiPlutoGridPage> {
  // -------------------------------------------------------------------------------------------
  // 初期処理 画面構築時だけ
  // -------------------------------------------------------------------------------------------
  ...
  // ウジェット処理
  // ------------------------------------------------------------------------------------------------
  late final UiPlutoGridPageWidget _pageWidget = UiPlutoGridPageWidget();
  @override
        ...
        child: Scaffold(
          ...
          appBar: PreferredSize(
            ...
            child: AppBarAreaWidget(
                titleName: PUIRoomEnum.uiPlutoGrid.title, popIcon: false),
          ),
          body: SafeArea(
              top: true,
              child: DefaultTextStyle.merge(
                ...
                child: Column(
                  ...
                  children: [
                    Expanded(
                        child: WaitWidget(
                            titleName: PUIRoomEnum.uiPlutoGrid.title,
...
class UiPlutoGridPageWidget extends ConsumerWidget {
  UiPlutoGridPageWidget({super.key});
