...
class UiMasamuneUniversalUiPage extends ConsumerStatefulWidget {
  const UiMasamuneUniversalUiPage({super.key});

  @override
  UiMasamuneUniversalUiPageState createState() =>
      UiMasamuneUniversalUiPageState();
}

class UiMasamuneUniversalUiPageState
    extends ConsumerState<UiMasamuneUniversalUiPage> {
  // -------------------------------------------------------------------------------------------
  // 初期処理 画面構築時だけ
  // -------------------------------------------------------------------------------------------
  ...
  // ウジェット処理
  // ------------------------------------------------------------------------------------------------
  late final UiMasamuneUniversalUiPageWidget _pageWidget =
      UiMasamuneUniversalUiPageWidget();
  @override
        ...
        child: Scaffold(
          ...
          appBar: PreferredSize(
            ...
            child: AppBarAreaWidget(
                titleName: PUIRoomEnum.uiMasamuneUniversal.title,
                popIcon: false),
          ),
          body: SafeArea(
              top: true,
...
class UiMasamuneUniversalUiPageWidget extends ConsumerWidget {
  UiMasamuneUniversalUiPageWidget({super.key});

  // -------------------------------------------------------------------------------------------
  // 部品
  // -------------------------------------------------------------------------------------------
  late final AppBarAreaWidget areaAppBar = AppBarAreaWidget(
      titleName: PUIRoomEnum.uiMasamuneUniversal.title, popIcon: false);
