...
class UiKatanaFormPage extends ConsumerStatefulWidget {
  const UiKatanaFormPage({super.key});

  @override
  UiKatanaFormPageState createState() => UiKatanaFormPageState();
}

class UiKatanaFormPageState extends ConsumerState<UiKatanaFormPage> {
  // -------------------------------------------------------------------------------------------
  // 初期処理 画面構築時だけ
  // -------------------------------------------------------------------------------------------
  ...
  // ウジェット処理
  // ------------------------------------------------------------------------------------------------
  late final UiKatanaFormPageWidget _pageWidget = UiKatanaFormPageWidget();
  @override
        ...
        child: Scaffold(
          ...
          appBar: PreferredSize(
            ...
            child: AppBarAreaWidget(
                titleName: PUIRoomEnum.uiKatanaForm.title, popIcon: false),
          ),
          body: SafeArea(
              top: true,
              child: DefaultTextStyle.merge(
                ...
                child: Column(
                  ...
                  children: [
                    Expanded(
                        child: WaitWidget(
                            titleName: PUIRoomEnum.uiKatanaForm.title,
...
class UiKatanaFormPageWidget extends ConsumerWidget {
  UiKatanaFormPageWidget({super.key});
